    ...
    .uni-calenda__content {
      .uni-calendar__panel {
        ...
        .uni-calendar__backtoday {
          ...
          height: 50rpx;
          line-height: 50rpx;
          // border: 1px rgba($color: #c72518, $alpha: 0.5) solid;
          border: 1px rgba($color: #00a0ea, $alpha: 0.5) solid;
          border-right: none;
          font-size: 24rpx;
          border-top-left-radius: 50rpx;
          border-bottom-left-radius: 50rpx;
          // color: rgba($color: #c72518, $alpha: 0.7);
          color: rgba($color: #00a0ea, $alpha: 0.7);
