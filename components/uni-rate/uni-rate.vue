<template>
	<view class="uni-rate">
		<view class="uni-rate-icon" v-for="(star,index) in stars" :key="index" :style="{marginLeft:margin+'px'}" @click="onClick(index)">
			<uni-icons :size="size" :color="color" :type="isFill === false || isFill === 'false' ? 'star' : 'star-filled'"></uni-icons>
			<view class="uni-rate-icon-on" :style="{width:star.activeWitch}">
				<uni-icons :size="size" :color="activeColor" type="star-filled"></uni-icons>
			</view>
		</view>
	</view>
</template>
